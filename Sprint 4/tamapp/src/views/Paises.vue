<template>
  <div class="body">
    <header>
      <div>
        <h1 class="titulo">
          <img src="../../Imagenes/LogoTAM.svg" alt="Logo" /> Tam Database
        </h1>
        <h3 class="subtitulo">La Base de Datos de Malaria Aviar Trópical</h3>
      </div>
    </header>
    <nav class="MenuWrap">
      <div class="menu-item">
        <a
          href="../FormularioContactarSoporte/contactar_soporte.html"
          class="ListItem"
          >Contáctanos</a
        >
      </div>
      <div class="menu-item">
        <a href="../FormularioInformes/informes.html" class="ListItem"
          >Consultas</a
        >
      </div>
    </nav>
    <main class="iniciar_sesion">
      <section>
        <div>
          ...
          <a href="#modal" id="button2"><label>Agregar</label></a>
        </div>
      </section>
    </main>
    <footer class="grid-container">
      <div class="item">
        Editores: Diana Gil-Vargas, Erasmo Martinez, Ricardo Ortega, Luis Ruiz,
        Leidy Valderrama & Jorge Hernandez<br />
    ...
    <div class="container">
      ...
      <section>
        <form id="form-reg" action="#" method="POST">
          ...
          <div class="campo">
            <input type="submit" id="boton-pais" value="Agregar" />
          </div>
        </form>
      </section>
    </div>
...
/*Sombrear de amarillo las opciones de nav (barra de menús)*/
.menu-item a:hover {
